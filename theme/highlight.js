...
;const k=Q(v);let x="",O=r||k;const M={},A=new p.__emitter(p);(()=>{const e=[]
...
;function Ne(e){const n=e.regex,t=pe,a={begin:/<[A-Za-z0-9\\._:-]+/,
...
}},i={$pattern:pe,keyword:_e,literal:he,built_in:ve,"variable.language":we
...
illegal:/%/},v={
match:n.concat(/\b/,(N=[...ye,"super","import"].map((e=>e+"\\s*\\(")),
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},be,r]}},grmr_javascript:Ne,
...
const n=e.regex,t=Ne(e),a=pe,i=["any","void","number","boolean","string","object","never","symbol","bigint","unknown"],r={
...
aliases:["yml"],contains:l}},grmr_zig:e=>{const n={
...
},t="[_a-zA-Z][_a-zA-Z0-9]*",a={match:/(u|i)\d+/,className:"type"};return{
...
contains:[e.APOS_STRING_MODE,e.QUOTE_STRING_MODE,e.C_BLOCK_COMMENT_MODE,a]
...
begin:/\/\//,end:/\n/,className:"comment"},a]}}});const Ke=te
;for(const e of Object.keys(Pe)){const n=e.replace("grmr_","").replace("_","-")
;Ke.registerLanguage(n,Pe[e])}return Ke}()
